...
// #warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=localhost;Port=54320;Database=pokemon_db;Username=postgres;Password=5ecretTunnel");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Evolution>(entity =>
        {
            ...
            entity.HasOne(d => d.EvolvesToNavigation).WithMany(p => p.EvolutionEvolvesToNavigations)
                .HasForeignKey(d => d.EvolvesTo)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_evolves_to_pokemon");

            entity.HasOne(d => d.Pokemon).WithMany(p => p.EvolutionPokemons)
        ...
        modelBuilder.Entity<Pokemon>(entity =>
        {
            ...
            entity.HasMany(d => d.Types).WithMany(p => p.Pokemons)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("PokemonId", "TypeId").HasName("pokemon_types_xref_pkey");
        ...
        modelBuilder.Entity<TrainersPokemon>(entity =>
        {
            ...
            entity.HasOne(d => d.Trainer).WithMany(p => p.TrainersPokemons)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_trainer_id_trainers");
        });

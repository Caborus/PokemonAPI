...
public partial class Pokemon
{
    ...
    public virtual ICollection<Evolution> EvolutionEvolvesToNavigations { get; set; } = new List<Evolution>();

    public virtual ICollection<Evolution> EvolutionPokemons { get; set; } = new List<Evolution>();
